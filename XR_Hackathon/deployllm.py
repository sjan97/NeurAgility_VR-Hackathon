...
UDP_IP = "127.0.0.1"   # if Unity on same machine
UDP_PORT = 5053
...
def send_metrics_to_unity(metrics):
    payload = {
        "type": "metrics",
    ...
    print("Sent metrics to Unity:", payload)
...
def send_llm_feedback_with_metrics(metrics, llm_feedback):
    payload = {
        ...
        "min_knee_angle": metrics.get("min_knee_angle"),
        "min_elbow_angle": metrics.get("min_elbow_angle"),
        "llm_feedback": llm_feedback  # <-- ADD FEEDBACK HERE
    }
